const music = new Audio("assests/audio/Arijit_songs/3.mp3");
// music.play();
const songs = [
  {
    id: 1,
    songName: `Bolna <br><div class="subtitle">Arijit Singh</div>`,
    poster: "assests/img/Ariimages/Bolna.png",
  },
  {
    id: 2,
    songName: `Chal Waha Jate hai <br><div class="subtitle">Arijit Singh</div>`,
    poster: "assests/img/Ariimages/Chal waha jate hai.png",
  },
  {
    id: 3,
    songName: `Deha Hazaro Dafa <br><div class="subtitle">Arijit Singh</div>`,
    poster: "assests/img/Ariimages/Dekha hazaro Dafa.png",
  },
  {
    id: 4,
    songName: `Wafa Ne Bewafai  <br><div class="subtitle">Arijit Singh</div>`,
    poster: "assests/img/Ariimages/Wafa ne bewafai.png",
  },
  // {
  //   id: 5,
  //   songName: `Ertugrul Gazi <br><div class="subtitle">Ertugurul</div>`,
  //   poster: "assests/img/5.png",
  // },
  // {
  //   id: 6,
  //   songName: `Electronic Music <br><div class="subtitle">Electro</div>`,
  //   poster: "assests/img/6.png",
  // },
  // {
  //   id: 7,
  //   songName: `Agar Tum Sath Ho <br><div class="subtitle">Tamashaa</div>`,
  //   poster: "assests/img/7.png",
  // },
  // {
  //   id: 8,
  //   songName: `Suna Hai <br><div class="subtitle">Neha Kakker</div>`,
  //   poster: "assests/img/8.png",
  // },
  // {
  //   id: 9,
  //   songName: `Dilbar <br><div class="subtitle">Satyameva Jayate</div>`,
  //   poster: "assests/img/9.png",
  // },
  // {
  //   id: 10,
  //   songName: `Duniya <br><div class="subtitle">Luka Chuppi</div>`,
  //   poster: "assests/img/10.png",
  // },
  // {
  //   id: 11,
  //   songName: `Lagdi Lahore Di <br><div class="subtitle">Street Dancer 3D</div>`,
  //   poster: "assests/img/11.png",
  // },
  // {
  //   id: 12,
  //   songName: `Putt Jatt Da <br><div class="subtitle">Putt Jatt Da</div>`,
  //   poster: "assests/img/12.png",
  // },
  // {
  //   id: 13,
  //   songName: `Baarishein <br><div class="subtitle"></div>`,
  //   poster: "assests/img/13.png",
  // },
  // {
  //   id: 14,
  //   songName: `Vaaste <br><div class="subtitle">Dhavni Bhanushali</div>`,
  //   poster: "assests/img/14.png",
  // },
  // {
  //   id: 15,
  //   songName: `Lut Gaye <br><div class="subtitle">Jubin Nautiyal</div>`,
  //   poster: "assests/img/15.png",
  // },
  // {
  //   id: 16,
  //   songName: `Tu Meri Zindagi Hai <br><div class="subtitle">Jubin Nautiyal</div>`,
  //   poster: "assests/img/16.png",
  // },
  // {
  //   id: 17,
  //   songName: `Zaroori Tha <br><div class="subtitle">Rahat Fateh Ali Khan</div>`,
  //   poster: "assests/img/17.png",
  // },
  // {
  //   id: 18,
  //   songName: `Mere Dhol Judaiyan <br><div class="subtitle">Ali Sethi Seha Gill</div>`,
  //   poster: "assests/img/18.png",
  // },
  // {
  //   id: 19,
  //   songName: `Eh Munde Pagal Ne Saare <br><div class="subtitle">Ap Dhillon, Gurinder Gill, Shinda Kahlon</div>`,
  //   poster: "assests/img/19.png",
  // },
  // {
  //   id: 20,
  //   songName: `Dunny 82K <br><div class="subtitle">Ap Dhillon, Gurinder Gill, Shinda Kahlon</div>`,
  //   poster: "assests/img/20.png",
  // },
];
...
Array.from(document.getElementsByClassName("playlistPlay")).forEach((e) => {
  e.addEventListener("click", (el) => {
    index = el.target.id;
    music.src = `assests/audio/Arijit_songs/${index}.mp3`;
    // way to fix img in masterplay
    poster_master_play.src = `assests/img/Ariimages/${index}.png`;
    music.play();
    masterPlay.classList.remove("bi-play-fill");
    masterPlay.classList.add("bi-pause-fill");
    download_music.href = `assests/audio/Arijit_songs/${index}.mp3`;
